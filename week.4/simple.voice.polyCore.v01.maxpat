...
,
		"classnamespace" : "box",
		"rect" : [ 919.0, 242.0, 1385.0, 1008.0 ],
		"gridsize" : [ 15.0, 15.0 ],
		"boxes" : [ 			{
				"box" : 				{
					"id" : "obj-51",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 497.0, 42.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.0, 453.5, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.0, 436.0, 58.0, 22.0 ],
					"text" : "r mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 519.452475247524944, 485.0, 56.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 436.0, 59.0, 22.0 ],
					"text" : "mute 0, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 50.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 817.0, 453.5, 244.0, 75.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 534.0, 272.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 24.0, 217.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 382.833333333333371, 171.0, 24.0, 20.0 ],
					"text" : "ms",
					"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 378.0, 409.0, 75.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 519.452475247524944, 315.0, 125.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 519.452475247524944, 300.0, 70.0, 20.0 ],
					"text" : "<function>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 28.335153614358386, 0.503940236860386, 0, 48.642255924171096, 0.262048598090235, 0, 120.425002530715119, 0.255329403267409, 0, 177.567846868819203, 0.0, 0 ],
					"classic_curve" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 192.0, 436.0, 204.833333333333371, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.471632540225983, 0.0, 1.0 ],
					"destination" : [ "obj-46", 0 ],
					"midpoints" : [ 222.5, 285.0, 303.0, 285.0, 303.0, 423.0, 375.0, 423.0, 375.0, 432.0, 523.5, 432.0 ],
					"source" : [ "obj-37", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.882220149040222, 0.0, 0.022930040955544, 1.0 ],
					"destination" : [ "obj-47", 0 ],
					"source" : [ "obj-50", 0 ]
				}
